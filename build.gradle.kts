...
dependencies {
    ...
    compileOnly("org.spigotmc:spigot-api:26.2-R0.1-SNAPSHOT") // 1.8.8-R0.1-SNAPSHOT 1.19.4-R0.1-SNAPSHOT 1.20.1-R0.1-SNAPSHOT 1.21-R0.1-SNAPSHOT 1.20.1-R0.1-SNAPSHOT
