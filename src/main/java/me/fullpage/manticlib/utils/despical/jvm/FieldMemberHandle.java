...
public class FieldMemberHandle extends NamedMemberHandle {
    ...
    public static final DynamicClassHandle VarHandle = ReflectionUtils.classHandle()
    ...
    static {
        ...
        try {
            modifierFieldJvm = ReflectionUtils.of(Field.class).setterField()
        ...
        try {
            ...
            MethodHandle PRIVATE_LOOKUP_IN = ReflectionUtils.of(MethodHandles.class).method()
